...
import com.bookReading.bookhub.adapter.DashboardRecyclerAdapter
...
class DashBoardFragment : Fragment() {
    ...
    var ratingComparator = Comparator<Book>{book1, book2 ->
        ...
        if(book1.bookRatting.compareTo(book2.bookRatting, true) == 0){
            book1.bookName.compareTo(book2.bookName, true)
        } else {
            book1.bookRatting.compareTo(book2.bookRatting, true)
        }
    }
